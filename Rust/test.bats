...
@test "xor" {
    ...
    [ "${lines[15]}" = "        ]," ]
    [ "${lines[16]}" = "    ]," ]
    [ "${lines[17]}" = "    biases_hidden: [" ]
    [ "${lines[18]}" = "        8.66080005088484," ]
    [ "${lines[19]}" = "        3.18102806812189," ]
    [ "${lines[20]}" = "    ]," ]
    [ "${lines[21]}" = "    weights_output: [" ]
    [ "${lines[22]}" = "        [" ]
    [ "${lines[23]}" = "            7.028474922350029," ]
    [ "${lines[24]}" = "            -7.0385257683402696," ]
    [ "${lines[25]}" = "            -1.730833624456504," ]
    [ "${lines[26]}" = "            -7.403271038308527," ]
    [ "${lines[27]}" = "            1.558925624888775," ]
    [ "${lines[28]}" = "            7.390186687736159," ]
    [ "${lines[29]}" = "        ]," ]
    [ "${lines[30]}" = "        [" ]
    [ "${lines[31]}" = "            -7.310426277309941," ]
    [ "${lines[32]}" = "            7.321118605351366," ]
    [ "${lines[33]}" = "            -7.038799017086555," ]
    [ "${lines[34]}" = "            -2.8002204628244836," ]
    [ "${lines[35]}" = "            7.071517018377268," ]
    [ "${lines[36]}" = "            3.21919221700788," ]
    [ "${lines[37]}" = "        ]," ]
    [ "${lines[38]}" = "    ]," ]
    [ "${lines[39]}" = "    biases_output: [" ]
    [ "${lines[40]}" = "        -3.245795100480243," ]
    [ "${lines[41]}" = "        3.250424023612059," ]
    [ "${lines[42]}" = "        5.246738011576049," ]
    [ "${lines[43]}" = "        3.363781250793568," ]
    [ "${lines[44]}" = "        -5.097046597754945," ]
    [ "${lines[45]}" = "        -3.361940360109141," ]
    [ "${lines[46]}" = "    ]," ]
    [ "${lines[47]}" = "    n_hidden: 2," ]
    [ "${lines[48]}" = "    n_outputs: 6," ]
    [ "${lines[49]}" = "}" ]
}

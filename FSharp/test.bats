...
@test "xor" {
    ...
    [ "${lines[9]}" = "     -3.36194036|]" ]
    [ "${lines[10]}" = "  WeightsHidden =" ]
    [ "${lines[11]}" = "   [|[|-5.942532663; -7.053489763|]; [|-5.938491793; -7.080670058|]|]" ]
    [ "${lines[12]}" = "  WeightsOutput =" ]
    [ "${lines[13]}" = "   [|[|7.028474922; -7.038525768; -1.730833624; -7.403271038; 1.558925625;" ]
    [ "${lines[14]}" = "       7.390186688|];" ]
    [ "${lines[15]}" = "     [|-7.310426277; 7.321118605; -7.038799017; -2.800220463; 7.071517018;" ]
    [ "${lines[16]}" = "       3.219192217|]|] }" ]
}
